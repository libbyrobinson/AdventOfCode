...
function Day6() {
  let totalYesCountPart1 = 0;
  let totalYesCountPart2 = 0;

  let yesCountsInGroup = new Map<string, number>();
  let peopleInGroup = 0;
    ...
    if (line) {
      ...
      for (var i = 0; i < line.length; i++) {
        yesCountsInGroup.set(
          line[i],
          yesCountsInGroup.has(line[i])
            ? (yesCountsInGroup.get(line[i]) as number) + 1
            : 1
        );
      }
    } else {
  ...
  return (
    <div>
      <h2>Day 6</h2>
      <p>
        The sum of the counts of questions to which anyone answered yes in a
        group for part 1 is {totalYesCountPart1}
      </p>
      <p>
        The sum of the counts of questions to which everyone answered yes in a
        group for part 2 is {totalYesCountPart2}
      </p>
    </div>
  );
}
